...
def stabilize_snapshot_runtime(monkeypatch: pytest.MonkeyPatch) -> None:
    """Reduce timer/animation jitter for deterministic SVG snapshots."""
    # Keep wave animations effectively static during snapshot capture.
    monkeypatch.setattr("kagan.ui.widgets.status_bar.WAVE_INTERVAL_MS", 60_000, raising=False)
    monkeypatch.setattr("kagan.ui.widgets.streaming_output.WAVE_INTERVAL_MS", 60_000, raising=False)
    monkeypatch.setattr("kagan.ui.modals.review.WAVE_INTERVAL_MS", 60_000, raising=False)
    ...
    async def send_prompt(self, prompt: str) -> str | None:
        ...
        if self._message_target:
            ...
            if self._thinking_text:
                ...
                # Yield once for deterministic processing without wall-clock delays
